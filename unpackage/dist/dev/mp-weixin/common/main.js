...
var _index = _interopRequireDefault(__webpack_require__(/*! common/request/index.js */ 12));
...
_App.default.mpType = 'app';var divider = function divider() {__webpack_require__.e(/*! require.ensure | components/common/divider */ "components/common/divider").then((function () {return resolve(__webpack_require__(/*! ./components/common/divider.vue */ 91));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};

_vue.default.component('divider', divider);var noThing = function noThing() {__webpack_require__.e(/*! require.ensure | components/common/no-thing */ "components/common/no-thing").then((function () {return resolve(__webpack_require__(/*! ./components/common/no-thing.vue */ 96));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
